...
\end{align*}
Este funcional puede ser minimizado variando los 1024 posibles valores
de $X,Y,Z,W$ dentro del rango $-1..1$ en un algorítmo numérico de
minimización. La minimización de los datos presentados en la
Fig. {fig:six_input_measures} se llevo a cabo usando la función \python{}
...
\label{fig:xyzw}
\end{figure}
\subsubsection{Algunos estados elípticos}
En la Fig. \ref{fig:elliptic_states} se ilustran estados de
polarización elípticos que hemos propuesto para evaluar
la exactitud del modelo obtenido. Estos estados son también
ortonormales 
\begin{figure}
\centering
\includegraphics[scale = .5]{EVD_EHI_E45D_Em45I.pdf}
\caption[Estados de polarización elípticos]{.}
...
simuladas usando el modelo obtenido]{Curvas de modulación experimentales comparadas con las
simuladas usando el modelo obtenido}
