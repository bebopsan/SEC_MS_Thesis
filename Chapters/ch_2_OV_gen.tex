...
traves de la interfaz de prototipado rápido Arduino. 
\begin{figure}[h!]
\centering
...
travéz de una librería de comunicación serial implementada en Python.

La componente mecánica del instrumento se describe a profundidad en el
apéndice \ref{AppendixA}, y los programas de interf[az de usuario y
comunicación serial se describen el apéndice B.

El proceso de toma de medidas que a una persona podría llevarle varios
...
La modulación de fase se midió usando un montaje interferométrico
