...
\subsection{Descripción y análisis de resultados simulados}
...
Se puede observar claramente que el m[etodo de PD coherente supera  
...
autores \citepChPD{Paxman1992,Jesacher2007} que han mostrado que la
...
Más aún, las propagaciones pueden propiciar la aparición de aberraciones del tipo Pistón ($Z_0$) o plano inclinado
...
equivalente en la  base Zernike tal y como muestra en
el capítulo 5 de \citepChPD{Schmidt2010}.


\begin{figure}[h!]
\centering
\includegraphics[scale=.3]{phase_comparison_esp.pdf}
\caption{Comparación visual y de coeficientes entre uno de los frentes
