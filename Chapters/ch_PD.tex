...
originales usadas en la simulación como la que se mostró en la figura
\ref{fig:mixed_mask}. Esta aberración no solo nos permite brobar el
método en una condición extrema, sino que también permite evaluar
su capacidad para encontrar aberraciones conocidas. 

La figura \ref{fig:exp_results} muestra uno de los resultados
obtenidos. 
En la primera fila, dentro de un rectángulo verde se muestran tres de las imágenes usadas para 

\begin{figure}[h!]
\centering
\includegraphics[scale=.8]{experimental_results_07032015_small.pdf}
