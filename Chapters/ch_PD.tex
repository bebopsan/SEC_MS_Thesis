...
formador de imágen. Es decir que si usamos un láser de buena calidad
...
ópticas de una fuente láser coherente, es decir: amplitud gaussiana, perfíl
...
Como el nuestro es un sistema formador de imágen y vamos a introducir las
...
espaciál puede dispersarse en tamaños comparativamente más
...
producir distorciones más grandes y más facilmente detectables en la
distribución de intensidad del plano imágen. Esto es particularmente
...
\caption{Un SLM es usado para introducir diversidades de fase en un
...
se vió en la sección ``referenciar sección'') introduce un una
...
de la modulación y al hecho de que los TN-SLM de trasmisión no logran
...
Wyant). La suma de las tres máscaras tal y como se le presenta al SLM
...
\caption{Ejemplo de una máscara tenedor que resulta de combinar una
...
y se enfoca para formar imágen ($|u_j^l|^2$) en el plano de observación o plano
imágen. 
...
% que la lente usada para colimar el haz hace imá. 
Como se puede ver en el extremo derecho de la figura \ref{fig:set-up},
los perfiles de intensidad que se usan como entrada para el algorítmo
...
óptico formador de imágen usando nuestro método, se deben registrar varias de las
...
TN-SLM.  
Introdcir las máscaras de fase genera distorisiones en la distribución
...
una solución única. Esta es la grán ventaja del PD sobre otros métodos
...
drásticos en sus distribuciones de intencidad cuando hay
...
condiciones de la simulación sean identicas a las condiciones del
...
Nuestro método fue probado extensivamente .
